    ...
    <div class="container">
        <div class="rounded-3 px-4 py-3" style="background-color: #e9ecef;">
            <div class="d-flex align-items-center" style="font-size: 14px;">
                ...
                <span class="text-secondary">Agenda Akademik</span>
            ...
            <div class="col-lg-9 ps-lg-5">
                ...
                <?php if(empty($data_agenda)): ?>
                    <div class="alert alert-warning text-center">
                        Tidak ada agenda ditemukan untuk tahun <strong><?= $selected_year ?></strong>.
                    </div>
                <?php else: ?>
                    ...
                    <div class="mb-5">
                        <div class="mb-3 overflow-hidden rounded-2" style="height: 350px;">
                            <img src="<?= base_url('assets/img/' . $agenda['gambar']) ?>" 
                                 class="w-100 h-100 object-fit-cover" 
                                 alt="Gambar Agenda"
                                 onerror="this.onerror=null; this.src='https://via.placeholder.com/800x400?text=Agenda+Image';">
                        </div>
                ...
                <div class="mt-4">
                    <nav aria-label="Page navigation">
                        <ul class="pagination">
                            ...
                            <li class="page-item">
                                <a class="page-link border text-dark" href="<?= base_url('dashboard/agenda/'.($current_page-1).'/'.$selected_year) ?>">Prev</a>
                            </li>
                            <?php endif; ?>
                            ...
                            <li class="page-item">
                                <a class="page-link border text-dark" href="<?= base_url('dashboard/agenda/'.($current_page+1).'/'.$selected_year) ?>">Next</a>
                            </li>
                            <?php endif; ?>
