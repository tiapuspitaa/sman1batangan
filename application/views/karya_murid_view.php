            ...
            <div class="col-md-6 col-lg-3">
                ...
                <div class="card border-0 h-100 shadow-sm rounded-0">
                    ...
                    <div class="card-body p-3" style="background-color: #e9ecef;">
                        ...
                        <h6 class="fw-bold text-uppercase mb-3" style="color: #102a43; font-size: 14px; min-height: 40px;">
                            <?= $item['judul'] ?>
                        </h6>

                        <div class="d-flex align-items-start mb-2 text-secondary" style="font-size: 12px;">
                            <i class="bi bi-person-fill me-2 fs-6"></i>
                            <span><?= $item['siswa'] ?></span>
                        </div>

                        <div class="d-flex align-items-center mb-2 text-secondary" style="font-size: 12px;">
...
<style>
    ...
    /* Agar kartu tidak rounded (kotak tegas sesuai gambar) */
